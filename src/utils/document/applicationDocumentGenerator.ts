...
export const generateApplicationDocumentHTML = (application: OrphanApplication): string => {
  return `<!DOCTYPE html>
<html lang="bn">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="checkbox-group">
        ...
        <div class="checkbox-item">
            <input type="radio" ${getPhysicalConditionText(application.basicInformation?.physicalCondition) === 'সুস্থ' ? 'checked' : ''} disabled>
            <span>সুস্থ</span>
        </div>
        <div class="checkbox-item">
            <input type="radio" ${getPhysicalConditionText(application.basicInformation?.physicalCondition) === 'অসুস্থ' ? 'checked' : ''} disabled>
            <span>অসুস্থ</span>
        </div>
        <div class="checkbox-item">
            <input type="radio" ${getPhysicalConditionText(application.basicInformation?.physicalCondition) === 'প্রতিবন্ধী' ? 'checked' : ''} disabled>
    ...
    <div class="footer-note">
        ...
        <p style="margin-top: 10px; font-size: 10px; color: #666;">
            Generated on: ${new Date().toLocaleDateString('bn-BD')} | Application ID: ${application.id || 'N/A'}
        </p>
    </div>
</body>
</html>`;
